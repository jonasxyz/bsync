...
print('fil2 URLs: ', len(file2_visited_urls))
...
print('Additional URLs in file2:', additional_urls_in_file2)
...
with open(csv_file_path, 'w', newline='') as f:
    ...
    writer.writerow(file1_data)
    writer.writerow(file2_data)
    writer.writerow(['Additional URLs in first file', num_additional_urls_in_file1, '', '', '', '', '', '', '\n'.join(additional_urls_in_file1)])

...
#my pleb edit bsync
def bsyncoptions(browser_params: BrowserParams, fo: Options) -> None:
    ...
    if browser_params.change_useragent:
        ...
        fo.set_preference("general.useragent.override", "StealthyWPM")
    if browser_params.set_proxy:
        #prefs["network.proxy.type"] = 1
        #prefs["network.proxy.ssl"] = "localhost"
        #prefs["network.proxy.ssl_port"] = "3031"

        fo.set_preference("network.proxy.type", 1)
        fo.set_preference("network.proxy.ssl", "localhost")
        fo.set_preference("network.proxy.ssl_port", "3031")     

const config = module.exports = {
    ...
    ip : "http://192.168.178.90",     // insert master-server ip
    port : 3000,                      // set master-server port (default 3000)
    allowed_ping : 100,               // set allowed ping between clients and server
    url_list : "tranco_1000.csv",       // insert name of the list containing the websites to crawl (.txt or .csv)
    calibration_runs : 10,             // set number of runs measuring the http access time between browsers (default 10)
